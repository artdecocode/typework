 ...
 * @typedef {import('../../index2').Application} _goa.Application
 * @typedef {import('../../index2').Request} _goa.Request
 * @typedef {import('../../index2').ContextDelegatedRequest} ContextDelegatedRequest
 * @typedef {import('../../index2').ContextDelegatedResponse} ContextDelegatedResponse
 * @typedef {import('../../index2').Response} _goa.Response
 */
